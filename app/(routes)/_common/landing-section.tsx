...
const LandingSection = () => {
  ...
  const suggestions = [
    ...
    },
    {
      ...
      icon: "🛍️",
      value:
        'Sneaker product page. Large high-quality product image on a light gray background. Color selector swatches, size selector grid, and a sticky "Add to Cart" button at the bottom. Title and price in bold, oversize typography. Mobile app, single screen. Style: Neo-Brutalism. High contrast, thick black outlines on buttons and cards, hard shadows (no blur), unrefined geometry, bold solid colors (yellow and black). Trendy streetwear aesthetic.',
    },
    {
      label: "Meditation",
      icon: "🧘‍♂️",
          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center justify-center">
            <div className="space-y-3">
              ...
              <p
                ...
                font-medium mb-8 text-foreground leading-relaxed
                sm:text-lg"
              >
    ...
    onClick={onRoute}>
      ...
      >
        {thumbnail ? (
          <img
          src={thumbnail}
          className="w-full h-full object-over object-left scale-110"
          />
        ):(
          <div 
        ...
        <div className="p-4 flex flex-col">
          ...
          truncate w-full mb-1 line-clamp-1">
            {project.name}
          </h3>
