...
export const CanvasProvider = ({
  ...
  const [
    ...
    // وانت شغال لو كهرت مشكله رجع الكومنت تااني في )(realetime)
    "idle"
    // hasInitialData ? "idle" : "running"
  );

  const theme = THEME_LIST.find(
    (t) => t.id === themeId
  );
  ...
  const selectedFrame =
    ...
    frames.length !== 0
      ...
      //  update the loadingstate inngest realtime
